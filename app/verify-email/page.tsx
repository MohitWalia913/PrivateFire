...
export default function VerifyEmailPage() {
  ...
  const handleResend = async () => {
    if (!email) {
      setStatus('Email is missing. Please sign up again.')
      return
    }
    ...
    try {
      ...
      setStatus(err instanceof Error ? err.message : 'Unable to resend verification email.')
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex">
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-600 to-orange-800 relative flex-col justify-between p-12 overflow-hidden">
        ...
        <div className="relative">
          ...
          <h2 className="text-4xl font-black text-white mb-4 leading-tight">Verify Your Email to Continue</h2>
          <p className="text-orange-100 mb-8 leading-relaxed">We sent you a confirmation link. Open it to activate your account and access your dashboard.</p>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-black text-gray-900 mb-2">Check your inbox</h1>
            <p className="text-gray-500 text-sm">Verify your email address to complete sign up.</p>
          </div>

          {status && <div className="bg-red-50 border border-red-200 rounded-lg px-4 py-3 text-red-600 text-sm mb-5">{status}</div>}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-gray-300 rounded-xl pl-9 pr-3 py-3.5 text-gray-900 text-sm placeholder-gray-400 focus:outline-none"
                />
              </div>
            </div>
          ...
          <p className="text-center text-gray-500 text-sm mt-6">
            Already verified?{' '}
            <Link href="/login" className="text-orange-500 hover:text-orange-400 font-medium">Go to Sign In</Link>
          </p>
        </div>
      </div>
    </div>
