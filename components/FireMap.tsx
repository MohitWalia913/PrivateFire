...
const CALFIRE_LAYERS: LayerConfig[] = [
  ...
  },
  {
    ...
    desc: 'CA vegetation types & fire fuel risk',
    color: '#16a34a',
    defaultOn: false,
    wmsUrl: 'https://egis.fire.ca.gov/arcgis/services/FRAP/fveg_WHR13/MapServer/WMSServer',
    wmsLayers: '0',
    opacity: 0.45,
    category: 'risk',
  },
  {
    id: 'dpa',
    label: 'Damage Prevention Areas',
    desc: 'Areas with active prevention obligations',
    color: '#f59e0b',
    defaultOn: false,
    wmsUrl: 'https://egis.fire.ca.gov/arcgis/services/FRAP/DPA/MapServer/WMSServer',
    wmsLayers: '0',
    opacity: 0.4,
    category: 'risk',
  },
  ...
  {
    id: 'stations',
    label: 'CAL FIRE Units & Stations',
    desc: 'Station boundaries and admin regions',
    color: '#8b5cf6',
    defaultOn: false,
    wmsUrl: 'https://egis.fire.ca.gov/arcgis/services/FRAP/CalFireUnits/MapServer/WMSServer',
    wmsLayers: '0',
    opacity: 0.5,
    category: 'boundaries',
  },
