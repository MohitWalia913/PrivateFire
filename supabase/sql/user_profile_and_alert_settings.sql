...
drop policy if exists "user_alert_notifications_select_own" on public.user_alert_notifications;
create policy "user_alert_notifications_select_own"
on public.user_alert_notifications for select
using (auth.uid() = user_id);
